...
const siteUrl = isProd ? 'https://match.minions.help' : (isDev ? 'https://match.minions.help' : 'http://localhost:4321');
...
export default defineConfig({
    ...
    integrations: [
        starlight({
            ...
            social: [
                { icon: 'github', label: 'GitHub', href: 'https://github.com/mxn2020/minions-match' },
                { icon: 'external', label: 'App', href: 'https://match.minions.wtf' },
            ],
            sidebar: [
                {
