# Manual Setup Steps for Minions Match
...
Go to **GitHub → mxn2020/minions-match → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-match` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-match-web`
- **GitHub repo**: `mxn2020/minions-match`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `match.minions.wtf`

### Documentation
- **Netlify site name**: `minions-match-docs`
- **GitHub repo**: `mxn2020/minions-match`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `match.minions.help`

### Blog
- **Netlify site name**: `minions-match-blog`
- **GitHub repo**: `mxn2020/minions-match`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `match.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `match.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `match.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `match.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-match/sdk`](https://www.npmjs.com/package/@minions-match/sdk)
- CLI: [`@minions-match/cli`](https://www.npmjs.com/package/@minions-match/cli)
...
Your package: [`minions-match`](https://pypi.org/project/minions-match/)
...
| Item | Value |
|------|-------|
| Project | `minions-match` |
| SDK (npm) | `@minions-match/sdk` |
| CLI (npm) | `@minions-match/cli` |
| Python (PyPI) | `minions-match` |
| GitHub | `github.com/mxn2020/minions-match` |
| Docs domain | `match.minions.help` |
| Blog domain | `match.minions.blog` |
| App domain | `match.minions.wtf` |
