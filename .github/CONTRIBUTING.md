# Contributing to Minions Match

Thank you for your interest in contributing to Minions Match!

## Getting Started

1. Fork the repository
2. Clone your fork: `git clone https://github.com/YOUR_USERNAME/minions-match.git`
